...
func (inst *ClaimVestedToken) findFindAuthorityAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
...
func (inst *ClaimVestedToken) FindAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindAuthorityAddress(bumpSeed)
	return
}

func (inst *ClaimVestedToken) MustFindAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindAuthorityAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *ClaimVestedToken) FindAuthorityAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindAuthorityAddress(0)
	return
}

func (inst *ClaimVestedToken) MustFindAuthorityAddress() (pda ag_solanago.PublicKey) {
...
func (inst *ClaimVestedToken) findFindVestingRecordAddress(poolState ag_solanago.PublicKey, beneficiary ag_solanago.PublicKey, knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
	// const: pool_vesting
...
// FindVestingRecordAddressWithBumpSeed calculates VestingRecord account address with given seeds and a known bump seed.
func (inst *ClaimVestedToken) FindVestingRecordAddressWithBumpSeed(poolState ag_solanago.PublicKey, beneficiary ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindVestingRecordAddress(poolState, beneficiary, bumpSeed)
	return
}

func (inst *ClaimVestedToken) MustFindVestingRecordAddressWithBumpSeed(poolState ag_solanago.PublicKey, beneficiary ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindVestingRecordAddress(poolState, beneficiary, bumpSeed)
	if err != nil {
		panic(err)
	}
...
// FindVestingRecordAddress finds VestingRecord account address with given seeds.
func (inst *ClaimVestedToken) FindVestingRecordAddress(poolState ag_solanago.PublicKey, beneficiary ag_solanago.PublicKey) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindVestingRecordAddress(poolState, beneficiary, 0)
	return
}

func (inst *ClaimVestedToken) MustFindVestingRecordAddress(poolState ag_solanago.PublicKey, beneficiary ag_solanago.PublicKey) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindVestingRecordAddress(poolState, beneficiary, 0)
	if err != nil {
		panic(err)
	}
	return
