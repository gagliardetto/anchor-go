...
func (inst *BuyExactOut) SetAmountOut(amount_out uint64) *BuyExactOut {
	inst.AmountOut = &amount_out
	return inst
}

// SetMaximumAmountIn sets the "maximum_amount_in" parameter.
func (inst *BuyExactOut) SetMaximumAmountIn(maximum_amount_in uint64) *BuyExactOut {
	inst.MaximumAmountIn = &maximum_amount_in
	return inst
}

// SetShareFeeRate sets the "share_fee_rate" parameter.
func (inst *BuyExactOut) SetShareFeeRate(share_fee_rate uint64) *BuyExactOut {
...
// PDA that acts as the authority for pool vault operations
// Generated using AUTH_SEED
func (inst *BuyExactOut) SetAuthorityAccount(authority ag_solanago.PublicKey) *BuyExactOut {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(authority)
	return inst
}

func (inst *BuyExactOut) findFindAuthorityAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
...
func (inst *BuyExactOut) FindAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindAuthorityAddress(bumpSeed)
	return
}

func (inst *BuyExactOut) MustFindAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindAuthorityAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *BuyExactOut) FindAuthorityAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindAuthorityAddress(0)
	return
}

func (inst *BuyExactOut) MustFindAuthorityAddress() (pda ag_solanago.PublicKey) {
...
// PDA that acts as the authority for pool vault operations
// Generated using AUTH_SEED
func (inst *BuyExactOut) GetAuthorityAccount() *ag_solanago.AccountMeta {
...
// Global configuration account containing protocol-wide settings
// Used to read protocol fee rates and curve type
func (inst *BuyExactOut) SetGlobalConfigAccount(globalConfig ag_solanago.PublicKey) *BuyExactOut {
...
// Global configuration account containing protocol-wide settings
// Used to read protocol fee rates and curve type
func (inst *BuyExactOut) GetGlobalConfigAccount() *ag_solanago.AccountMeta {
...
// Platform configuration account containing platform-wide settings
// Used to read platform fee rate
func (inst *BuyExactOut) SetPlatformConfigAccount(platformConfig ag_solanago.PublicKey) *BuyExactOut {
...
// Platform configuration account containing platform-wide settings
// Used to read platform fee rate
func (inst *BuyExactOut) GetPlatformConfigAccount() *ag_solanago.AccountMeta {
...
// The pool state account where the swap will be performed
// Contains current pool parameters and balances
func (inst *BuyExactOut) SetPoolStateAccount(poolState ag_solanago.PublicKey) *BuyExactOut {
...
// The pool state account where the swap will be performed
// Contains current pool parameters and balances
func (inst *BuyExactOut) GetPoolStateAccount() *ag_solanago.AccountMeta {
...
// The user's token account for base tokens (tokens being bought)
// Will receive the output tokens after the swap
func (inst *BuyExactOut) SetUserBaseTokenAccount(userBaseToken ag_solanago.PublicKey) *BuyExactOut {
...
// The user's token account for base tokens (tokens being bought)
// Will receive the output tokens after the swap
func (inst *BuyExactOut) GetUserBaseTokenAccount() *ag_solanago.AccountMeta {
...
// The user's token account for quote tokens (tokens being sold)
// Will be debited for the input amount
func (inst *BuyExactOut) SetUserQuoteTokenAccount(userQuoteToken ag_solanago.PublicKey) *BuyExactOut {
...
// The user's token account for quote tokens (tokens being sold)
// Will be debited for the input amount
func (inst *BuyExactOut) GetUserQuoteTokenAccount() *ag_solanago.AccountMeta {
...
// The pool's vault for base tokens
// Will be debited to send tokens to the user
func (inst *BuyExactOut) SetBaseVaultAccount(baseVault ag_solanago.PublicKey) *BuyExactOut {
...
// The pool's vault for base tokens
// Will be debited to send tokens to the user
func (inst *BuyExactOut) GetBaseVaultAccount() *ag_solanago.AccountMeta {
...
// The pool's vault for quote tokens
// Will receive the input tokens from the user
func (inst *BuyExactOut) SetQuoteVaultAccount(quoteVault ag_solanago.PublicKey) *BuyExactOut {
...
// The pool's vault for quote tokens
// Will receive the input tokens from the user
func (inst *BuyExactOut) GetQuoteVaultAccount() *ag_solanago.AccountMeta {
...
// The mint of the base token
// Used for transfer fee calculations if applicable
func (inst *BuyExactOut) SetBaseTokenMintAccount(baseTokenMint ag_solanago.PublicKey) *BuyExactOut {
...
// The mint of the base token
// Used for transfer fee calculations if applicable
func (inst *BuyExactOut) GetBaseTokenMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

// SetQuoteTokenMintAccount sets the "quote_token_mint" account.
// The mint of the quote token
func (inst *BuyExactOut) SetQuoteTokenMintAccount(quoteTokenMint ag_solanago.PublicKey) *BuyExactOut {
...
// The mint of the quote token
func (inst *BuyExactOut) GetQuoteTokenMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(10)
}

// SetBaseTokenProgramAccount sets the "base_token_program" account.
// SPL Token program for base token transfers
func (inst *BuyExactOut) SetBaseTokenProgramAccount(baseTokenProgram ag_solanago.PublicKey) *BuyExactOut {
...
// SPL Token program for base token transfers
func (inst *BuyExactOut) GetBaseTokenProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(11)
}

// SetQuoteTokenProgramAccount sets the "quote_token_program" account.
// SPL Token program for quote token transfers
func (inst *BuyExactOut) SetQuoteTokenProgramAccount(quoteTokenProgram ag_solanago.PublicKey) *BuyExactOut {
...
// SPL Token program for quote token transfers
func (inst *BuyExactOut) GetQuoteTokenProgramAccount() *ag_solanago.AccountMeta {
...
func (inst *BuyExactOut) findFindEventAuthorityAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
...
func (inst *BuyExactOut) FindEventAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindEventAuthorityAddress(bumpSeed)
	return
}

func (inst *BuyExactOut) MustFindEventAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindEventAuthorityAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *BuyExactOut) FindEventAuthorityAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindEventAuthorityAddress(0)
	return
}

func (inst *BuyExactOut) MustFindEventAuthorityAddress() (pda ag_solanago.PublicKey) {
...
func NewBuyExactOutInstruction(
	...
	program ag_solanago.PublicKey) *BuyExactOut {
