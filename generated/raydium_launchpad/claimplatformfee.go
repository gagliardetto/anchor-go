...
func (inst *ClaimPlatformFee) findFindAuthorityAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
...
func (inst *ClaimPlatformFee) FindAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindAuthorityAddress(bumpSeed)
	return
}

func (inst *ClaimPlatformFee) MustFindAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindAuthorityAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *ClaimPlatformFee) FindAuthorityAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindAuthorityAddress(0)
	return
}

func (inst *ClaimPlatformFee) MustFindAuthorityAddress() (pda ag_solanago.PublicKey) {
...
func (inst *ClaimPlatformFee) findFindRecipientTokenAccountAddress(platformFeeWallet ag_solanago.PublicKey, quoteMint ag_solanago.PublicKey, knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
	// path: platformFeeWallet
	seeds = append(seeds, platformFeeWallet.Bytes())
...
// FindRecipientTokenAccountAddressWithBumpSeed calculates RecipientTokenAccount account address with given seeds and a known bump seed.
func (inst *ClaimPlatformFee) FindRecipientTokenAccountAddressWithBumpSeed(platformFeeWallet ag_solanago.PublicKey, quoteMint ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindRecipientTokenAccountAddress(platformFeeWallet, quoteMint, bumpSeed)
	return
}

func (inst *ClaimPlatformFee) MustFindRecipientTokenAccountAddressWithBumpSeed(platformFeeWallet ag_solanago.PublicKey, quoteMint ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindRecipientTokenAccountAddress(platformFeeWallet, quoteMint, bumpSeed)
	if err != nil {
		panic(err)
	}
...
// FindRecipientTokenAccountAddress finds RecipientTokenAccount account address with given seeds.
func (inst *ClaimPlatformFee) FindRecipientTokenAccountAddress(platformFeeWallet ag_solanago.PublicKey, quoteMint ag_solanago.PublicKey) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindRecipientTokenAccountAddress(platformFeeWallet, quoteMint, 0)
	return
}

func (inst *ClaimPlatformFee) MustFindRecipientTokenAccountAddress(platformFeeWallet ag_solanago.PublicKey, quoteMint ag_solanago.PublicKey) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindRecipientTokenAccountAddress(platformFeeWallet, quoteMint, 0)
	if err != nil {
		panic(err)
	}
	return
