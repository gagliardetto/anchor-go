...
func (inst *CreateVestingAccount) findFindVestingRecordAddress(poolState ag_solanago.PublicKey, beneficiary ag_solanago.PublicKey, knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
	// const: pool_vesting
...
func (inst *CreateVestingAccount) FindVestingRecordAddressWithBumpSeed(poolState ag_solanago.PublicKey, beneficiary ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindVestingRecordAddress(poolState, beneficiary, bumpSeed)
	return
}

func (inst *CreateVestingAccount) MustFindVestingRecordAddressWithBumpSeed(poolState ag_solanago.PublicKey, beneficiary ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindVestingRecordAddress(poolState, beneficiary, bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *CreateVestingAccount) FindVestingRecordAddress(poolState ag_solanago.PublicKey, beneficiary ag_solanago.PublicKey) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindVestingRecordAddress(poolState, beneficiary, 0)
	return
}

func (inst *CreateVestingAccount) MustFindVestingRecordAddress(poolState ag_solanago.PublicKey, beneficiary ag_solanago.PublicKey) (pda ag_solanago.PublicKey) {
