...
func (inst *BuyExactIn) SetAmountIn(amount_in uint64) *BuyExactIn {
	inst.AmountIn = &amount_in
	return inst
}

// SetMinimumAmountOut sets the "minimum_amount_out" parameter.
func (inst *BuyExactIn) SetMinimumAmountOut(minimum_amount_out uint64) *BuyExactIn {
	inst.MinimumAmountOut = &minimum_amount_out
	return inst
}

// SetShareFeeRate sets the "share_fee_rate" parameter.
func (inst *BuyExactIn) SetShareFeeRate(share_fee_rate uint64) *BuyExactIn {
...
// PDA that acts as the authority for pool vault operations
// Generated using AUTH_SEED
func (inst *BuyExactIn) SetAuthorityAccount(authority ag_solanago.PublicKey) *BuyExactIn {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(authority)
	return inst
}

func (inst *BuyExactIn) findFindAuthorityAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
...
func (inst *BuyExactIn) FindAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindAuthorityAddress(bumpSeed)
	return
}

func (inst *BuyExactIn) MustFindAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindAuthorityAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *BuyExactIn) FindAuthorityAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindAuthorityAddress(0)
	return
}

func (inst *BuyExactIn) MustFindAuthorityAddress() (pda ag_solanago.PublicKey) {
...
// PDA that acts as the authority for pool vault operations
// Generated using AUTH_SEED
func (inst *BuyExactIn) GetAuthorityAccount() *ag_solanago.AccountMeta {
...
// Global configuration account containing protocol-wide settings
// Used to read protocol fee rates and curve type
func (inst *BuyExactIn) SetGlobalConfigAccount(globalConfig ag_solanago.PublicKey) *BuyExactIn {
...
// Global configuration account containing protocol-wide settings
// Used to read protocol fee rates and curve type
func (inst *BuyExactIn) GetGlobalConfigAccount() *ag_solanago.AccountMeta {
...
// Platform configuration account containing platform-wide settings
// Used to read platform fee rate
func (inst *BuyExactIn) SetPlatformConfigAccount(platformConfig ag_solanago.PublicKey) *BuyExactIn {
...
// Platform configuration account containing platform-wide settings
// Used to read platform fee rate
func (inst *BuyExactIn) GetPlatformConfigAccount() *ag_solanago.AccountMeta {
...
// The pool state account where the swap will be performed
// Contains current pool parameters and balances
func (inst *BuyExactIn) SetPoolStateAccount(poolState ag_solanago.PublicKey) *BuyExactIn {
...
// The pool state account where the swap will be performed
// Contains current pool parameters and balances
func (inst *BuyExactIn) GetPoolStateAccount() *ag_solanago.AccountMeta {
...
// The user's token account for base tokens (tokens being bought)
// Will receive the output tokens after the swap
func (inst *BuyExactIn) SetUserBaseTokenAccount(userBaseToken ag_solanago.PublicKey) *BuyExactIn {
...
// The user's token account for base tokens (tokens being bought)
// Will receive the output tokens after the swap
func (inst *BuyExactIn) GetUserBaseTokenAccount() *ag_solanago.AccountMeta {
...
// The user's token account for quote tokens (tokens being sold)
// Will be debited for the input amount
func (inst *BuyExactIn) SetUserQuoteTokenAccount(userQuoteToken ag_solanago.PublicKey) *BuyExactIn {
...
// The user's token account for quote tokens (tokens being sold)
// Will be debited for the input amount
func (inst *BuyExactIn) GetUserQuoteTokenAccount() *ag_solanago.AccountMeta {
...
// The pool's vault for base tokens
// Will be debited to send tokens to the user
func (inst *BuyExactIn) SetBaseVaultAccount(baseVault ag_solanago.PublicKey) *BuyExactIn {
...
// The pool's vault for base tokens
// Will be debited to send tokens to the user
func (inst *BuyExactIn) GetBaseVaultAccount() *ag_solanago.AccountMeta {
...
// The pool's vault for quote tokens
// Will receive the input tokens from the user
func (inst *BuyExactIn) SetQuoteVaultAccount(quoteVault ag_solanago.PublicKey) *BuyExactIn {
...
// The pool's vault for quote tokens
// Will receive the input tokens from the user
func (inst *BuyExactIn) GetQuoteVaultAccount() *ag_solanago.AccountMeta {
...
// The mint of the base token
// Used for transfer fee calculations if applicable
func (inst *BuyExactIn) SetBaseTokenMintAccount(baseTokenMint ag_solanago.PublicKey) *BuyExactIn {
...
// The mint of the base token
// Used for transfer fee calculations if applicable
func (inst *BuyExactIn) GetBaseTokenMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

// SetQuoteTokenMintAccount sets the "quote_token_mint" account.
// The mint of the quote token
func (inst *BuyExactIn) SetQuoteTokenMintAccount(quoteTokenMint ag_solanago.PublicKey) *BuyExactIn {
...
// The mint of the quote token
func (inst *BuyExactIn) GetQuoteTokenMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(10)
}

// SetBaseTokenProgramAccount sets the "base_token_program" account.
// SPL Token program for base token transfers
func (inst *BuyExactIn) SetBaseTokenProgramAccount(baseTokenProgram ag_solanago.PublicKey) *BuyExactIn {
...
// SPL Token program for base token transfers
func (inst *BuyExactIn) GetBaseTokenProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(11)
}

// SetQuoteTokenProgramAccount sets the "quote_token_program" account.
// SPL Token program for quote token transfers
func (inst *BuyExactIn) SetQuoteTokenProgramAccount(quoteTokenProgram ag_solanago.PublicKey) *BuyExactIn {
...
// SPL Token program for quote token transfers
func (inst *BuyExactIn) GetQuoteTokenProgramAccount() *ag_solanago.AccountMeta {
...
func (inst *BuyExactIn) findFindEventAuthorityAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
...
func (inst *BuyExactIn) FindEventAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindEventAuthorityAddress(bumpSeed)
	return
}

func (inst *BuyExactIn) MustFindEventAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindEventAuthorityAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *BuyExactIn) FindEventAuthorityAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindEventAuthorityAddress(0)
	return
}

func (inst *BuyExactIn) MustFindEventAuthorityAddress() (pda ag_solanago.PublicKey) {
...
func NewBuyExactInInstruction(
	...
	program ag_solanago.PublicKey) *BuyExactIn {
